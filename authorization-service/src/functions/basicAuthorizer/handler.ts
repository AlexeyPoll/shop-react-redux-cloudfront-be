import {APIGatewayTokenAuthorizerEvent, APIGatewayAuthorizerResultContext, APIGatewayAuthorizerCallback} from "aws-lambda";
import 'dotenv/config';
const basicAuthorizer = async (event: APIGatewayTokenAuthorizerEvent, _context: APIGatewayAuthorizerResultContext, callback: APIGatewayAuthorizerCallback) => {
    try {
